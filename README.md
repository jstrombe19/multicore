...
```
cd existing_repo
git remote add origin https://gitserver.idm.orionspace.com/casidi/sandbox/multicore.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitserver.idm.orionspace.com/casidi/sandbox/multicore/-/settings/integrations)
